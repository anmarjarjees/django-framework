...
# Name: name=the required view function which is used to create links with templates
...
urlpatterns = [
    ...
    # name='home' will be used when we create the hyperlink dynamically to reference this page
    ...
    # again name='about' will be used when we create the link dynamically to reference this page
    ...
    # So let's name our var_name that will represent the id for the student to x
    # NOTE: the variable name we use here has to be the same variable name we pass to the view function
    # In other word:
    ...
    path('registration/<int:student_id>/',
