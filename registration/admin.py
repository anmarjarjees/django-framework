...
# Embed/Insert the Student Model (Class) and the Worskshop Model (class)
...
# We need register this class with the admin to indentify its associated model
...
# that inhirits from admin.ModelAdmin:
# As you remeber in our basic example class Basic_Member(Member) :-)
class StudentAdmin(admin.ModelAdmin):
    ...
    pass # <= I will comment "pass" becuase I will add some code below
