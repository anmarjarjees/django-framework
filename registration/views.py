...
# being very specific by writing the application name
...
def home(request):
    ...
    # We used [Python Shell] to practice these commands
    ...
    # This command will grab all the objects in our student table
...
def about(request):
    ...
    course_list = ['HTML and CSS', 'Bootstrap', 'JavaScript',
                   'Python', 'Flask Framework', 'Django Framework']
...
# *************************************************************
# Notice that the two functions (views) are not being called
# because we didn't add a path() function for each one inside urls.py


def services(request):
    # if the function is completely empty => ErrorIndentationError: expected an indented block
